...
int try_parse_opcode_builtin(const char **cursor,
  ...
  static const expr_named_builtin_entry unary_builtins[] = {
      ...
      {"vertex_ids", GVM_OP_HYPERGRAPH_VERTEX_IDS},
      {"vertices", GVM_OP_HYPERGRAPH_VERTICES},
      {"hyperedges", GVM_OP_HYPERGRAPH_HYPEREDGES},
  };
  static const expr_named_builtin_entry binary_builtins[] = {
      ...
      {"vertex_attrs", GVM_OP_HYPERGRAPH_VERTEX_ATTRS},
      {"hyperedge_vertices", GVM_OP_HYPERGRAPH_HYPEREDGE_VERTICES},
      {"hyperedge_attrs", GVM_OP_HYPERGRAPH_HYPEREDGE_ATTRS},
      {"has_vertex", GVM_OP_HYPERGRAPH_HAS_VERTEX},
      {"has_hyperedge", GVM_OP_HYPERGRAPH_HAS_HYPEREDGE},
      {"incident_hyperedges", GVM_OP_HYPERGRAPH_INCIDENT_HYPEREDGES},
