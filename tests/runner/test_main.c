...
int main(int argc, char **argv) {
  const test_case tests[] = {
      ...
      {"vm_csc_builtin_opcode", test_vm_csc_builtin_opcode},
      {"vm_sec_builtin_opcode", test_vm_sec_builtin_opcode},
      ...
      {"vm_sech_builtin_opcode", test_vm_sech_builtin_opcode},
      {"vm_csch_builtin_opcode", test_vm_csch_builtin_opcode},
      {"vm_coth_builtin_opcode", test_vm_coth_builtin_opcode},
      ...
      {"vm_cosh_builtin_opcode", test_vm_cosh_builtin_opcode},
      {"vm_tanh_builtin_opcode", test_vm_tanh_builtin_opcode},
      {"vm_atanh_builtin_opcode", test_vm_atanh_builtin_opcode},
      {"vm_cos_builtin_opcode", test_vm_cos_builtin_opcode},
        ...
        {"vm_fdim_builtin_opcode", test_vm_fdim_builtin_opcode},
        {"vm_remainder_builtin_opcode", test_vm_remainder_builtin_opcode},
        {"vm_rint_builtin_opcode", test_vm_rint_builtin_opcode},
