...
- `11_graphs.gion`
  - first-class graph declarations with `graph Name;`, node blocks, node/edge attributes, undirected/directed edges, graph inspection builtins, graph attribute lookup builtins, basic membership/neighbor queries, and structural graph mutation
