...
- `04_conditionals.gion`
  - `if / elif / else`, nested conditionals, grouped multiline conditions, ternary expressions, equality/ordering conditions (`==`, `!=`, `<`, `<=`, `>`, `>=`), `and` / `nand` / `or` / `nor` / `not`, and accepted `0` / `1` conditions
- `05_comments.gion`
