...
from bench_paths import ASM_FALLBACK_JSON, ASM_FALLBACK_MD
...
def main() -> int:
    ...
    parser.add_argument("--output-json", default=str(ASM_FALLBACK_JSON), help="JSON output path")
    parser.add_argument("--output-md", default=str(ASM_FALLBACK_MD), help="Markdown output path")
