...
- the Bash and PowerShell quality-gate entry points should stay aligned on build, test, clang-tidy, and optional cppcheck behavior
- the Bash and PowerShell repo-gate entry points should stay aligned on repo-health, docs build, spellcheck, and the Docker-based link-check behavior used in CI
