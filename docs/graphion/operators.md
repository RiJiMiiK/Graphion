...
2. `abs(...)`, `min(...)`, `max(...)`, `clamp(...)`, `sqrt(...)`, `cbrt(...)`, `sin(...)`, `sinh(...)`, `asinh(...)`, `acosh(...)`, `cos(...)`, `cosh(...)`, `tan(...)`, `tanh(...)`, `atanh(...)`, `asin(...)`, `acos(...)`, `atan(...)`, `atan2(...)`, `hypot(...)`, `copysign(...)`, `fma(...)`, `fdim(...)`, `remainder(...)`, `rint(...)`, `exp(...)`, `expm1(...)`, `log1p(...)`, `erf(...)`, `erfc(...)`, `gamma(...)`, `ln(...)`, `log(...)`, `log10(...)`, `log2(...)`, `floor(...)`, `ceil(...)`, `round(...)`, `trunc(...)`, `sign(...)`, `len(...)`
3. postfix factorial `!`
4. `**`
5. `*`, `/`, `//`, `%`
6. `+`, `-`
