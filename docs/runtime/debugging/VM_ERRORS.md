...
- `GVM_OP_NEIGHBOR_WEIGHT_SUM` uses `GVM_ERR_CSR_UNBOUND`, `GVM_ERR_INVALID_NODE_ID`, and `GVM_ERR_CSR_WEIGHTS_UNBOUND`
- `GVM_OP_NEIGHBOR_ATTR_SUM` uses `GVM_ERR_CSR_UNBOUND`, `GVM_ERR_INVALID_NODE_ID`, and `GVM_ERR_CSR_EDGE_ATTRS_UNBOUND`
