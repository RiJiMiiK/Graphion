...
- ABI/register mapping for current hotpath: `docs/runtime/asm/ASM_REGISTERS.md`.
- C fallback parity and performance policy: `docs/performance/policies/ASM_FALLBACK_POLICY.md`.
